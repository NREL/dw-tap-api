...
export CONFIG_FILE_URL=https://github.nrel.gov/nrel-cloud-computing/appfleet-api/raw/main/appfleet-config/appfleet.yml
# Properly format the JSON for APPFLEET_BUILD_ARGS
export APPFLEET_BUILD_ARGS='{"main": {"image_detail": "./appfleet-config/mainDetail.json", "dockerfile": "./Dockerfile", "ecr_repo": "$(REGISTRY-IDS).dkr.ecr.us-west-2.amazonaws.com/nrel-windwatts-api-${APPFLEET_RELEASE_NAME}", "target_arg": ""}}'
export CACHE_S3_BUCKET=nrel-windwatts-api-codebuild
