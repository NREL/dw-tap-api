...
def v1_wr():
    ...
    @apiSuccess {String} JSON with percentage observations in each of 8 radial segments (N, NE, E, SE, S, SW, W, NW) and each of 4 wind speed classes (11-14 mps, 8-11 mps, 5-8 mps, less than 5 mps) and all together ("All")
