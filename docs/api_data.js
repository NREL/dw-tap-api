        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "height",
            "description": "<p>Height (in meters) for which the wind direction estimates are requested; notation: <code>XXm</code>, where XX is an integer or float</p>"
          },
          {
            "group": "Parameter",
            "type": "Float",
          ...
          },
          {
            ...
            "optional": true,
            "field": "obstacles",
            "description": "<p>Optional file to be uploaded. This geojson file should have obstacle description for the specific studied site. The file upload needs to happen as part of the <code>POST</code> http request, as demonstrated in the <a href=\"https://github.com/NREL/dw-tap-api/blob/develop/test/geojson-upload.ipynb\">notebook</a>.</p>"
          }
        ]
      }
    },
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "height",
            "description": "<p>Height (in meters) for which the windspeed estimates are requested; notation: <code>XXm</code>, where XX is an integer or float</p>"
          },
          {
            "group": "Parameter",
            "type": "Float",
