...
import { Card, CardHeader, CardContent, CardActions, Button, Collapse, Typography } from '@mui/material';
...
const ResultCard = ({ 
    data = {
        ...
        details: ['Additional details about wind resources:',
    ...
    return (
        <Card sx={{ maxWidth: 210, margin: 'auto', mt: 5 }}>
            <CardHeader
                title={data.title}
            ...
            <Collapse in={expanded} timeout="auto" unmountOnExit>
                <CardContent>
                    {data.details.map((detail, index) => (
                        <Typography key={'result_detail' + index}>
                            {detail}
                            </Typography>
                    ))}
                </CardContent>
